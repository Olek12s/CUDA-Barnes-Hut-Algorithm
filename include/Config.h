...
static constexpr int SPLIT_AT_LEAF_SIZE = 10000000;
constexpr int MAX_MORTON_BITS = 21;
float EPSILON = 0.05;   // smaller - sharper physics | larger - smoother and more stable physics | Prevents infinite forces when distance r ~0. Prefferable [0.01-0.5]
