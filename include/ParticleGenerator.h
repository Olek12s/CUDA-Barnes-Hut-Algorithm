...
public:
    ...
    static void createPlummerSphere(std::vector<Particle>& particles, float x, float y, float z, int count, float particleMass, float scaleRadius, float vx = 0.0f, float vy = 0.0f, float vz = 0.0f);
